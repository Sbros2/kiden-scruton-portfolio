...
## Simulation program
The gallery includes an animated preview of my saved Falstad circuit, alongside the PSpice study figures. The preview samples the running model; its playback speed is not a time scale for measurements. [Download the original Falstad circuit](/documents/piezo-falstad-circuit.txt) to import it into the simulator.
